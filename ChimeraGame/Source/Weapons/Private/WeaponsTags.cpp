...
namespace WeaponsTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Slot_Arm_Left,					"Weapons.Slot.Arm.Left",					"Left arm of a character, usually used for shields.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Slot_Arm_Right,					"Weapons.Slot.Arm.Right",					"Right arm of a character, usually used for shields.");
